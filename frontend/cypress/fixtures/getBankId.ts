...
const orderRef = 'f1586c23-019a-475a-b8c7-d5f7b36e8e96';
...
export const getStatusCancelled = () => {
...
export const getStatusComplete = () => {
  return {
    message: 'success',
    data: {
      orderRef,
