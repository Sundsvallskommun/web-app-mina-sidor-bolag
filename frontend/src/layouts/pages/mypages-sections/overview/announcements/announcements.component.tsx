...
export const announcementsSource: Announcement[] = [
  {
    id: 0,
    title: 'Ändrade allmänna avtalsvillkor ',
    text: 'Vi vill informera dig om att allmänna villkor för elnätsavtal har uppdaterats. Ändringarna gäller från och med 1 januari 2026. Observera att de nya allmänna avtalsvillkoren inte innebär några ändrade avgifter. Branschföreningen Energiföretagen Sverige och Konsumentverket har gemensamt reviderat de allmänna avtalsvillkoren för anslutning och överföring av el till konsumenter. Förändringarna görs bland annat för att förtydliga villkoren och anpassa dem till nya lagkrav.',
    urlTitle: 'På vår hemsida sundsvallelnat.se hittar du de nya avtalsvillkoren i sin helhet',
    url: 'https://sundsvallelnat.se/min-anslutning/priser-och-avtalsvillkor/allmanna-avtalsvillkor/allmanna-avtalsvillkor-konsument',
    groups: [AnnouncementGroup.CUSTOMER_SV_EL],
    image: '/andrade-allmanna-avtalsvillkor.png',
    imageAlt: '',
  },
  {
    id: 1,
