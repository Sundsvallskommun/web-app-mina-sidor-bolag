  ...
  return (
    <>
      <fieldset className="flex flex-col gap-12">
        ...
        <RadioButton.Group className="gap-8 lg:!flex-row lg:gap-16" size="lg" value={value.activityTypeFilter}>
      ...
      <div className="flex flex-col gap-8">
        <FormLabel className="text-label-large lg:hidden">{t('activity:filter.period')}</FormLabel>
        <div className="sm:flex gap-16">
          <div className="sm:flex sm:flex-1 sm:flex-col gap-8">
          ...
          <div className="sm:flex sm:flex-1 sm:flex-col gap-8 sm:mt-0 mt-16">
...
const DesktopFilterBar = ({ value, onChange }: ActivityFilterProps): ReactElement => (
  <div className="hidden lg:flex lg:items-end lg:justify-between lg:gap-24 h-[86px]">
  ...
  return (
    <>
      ...
      <Modal
        ...
        labelAs="h2"
        className="lg:hidden w-full lg:bottom-auto lg:left-auto lg:rounded-cards lg:relative bottom-0 fixed left-0 rounded-b-0"
